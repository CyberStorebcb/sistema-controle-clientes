<template>
  <q-page :class="pageClasses" class="q-pa-md">
        ...
        <q-card class="q-pa-md">
          ...
          <q-card-section>
            ...
            <q-list v-else separator>
              <q-item v-for="(cliente, index) in clientes" :key="index" class="q-pa-md">
                <q-item-section>
                  <q-item-label class="text-weight-bold">
                    {{ cliente.nome }}
                  </q-item-label>
                  <q-item-label caption> CPF: {{ cliente.cpf }} </q-item-label>
...
// Computed para classes do modo dark
...
const adicionarCliente = async () => {
  ...
  try {
    ...
    const cpfExiste = clientes.value.some(
      (cliente) => cliente.cpf.replace(/\D/g, '') === novoCliente.cpf.replace(/\D/g, ''),
    )
